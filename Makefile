...
.PHONY: all reset_submodules clean clean_s2geometry build_s2geometry patch_s2geometry depatch_s2geometry build_s2geometry_impl install_s2geometry
...
build_s2geometry: 
	$(MAKE) patch_s2geometry build_s2geometry_impl depatch_s2geometry
